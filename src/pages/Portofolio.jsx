    ...
    return (
        <div class="bg-gray-700 w-full text-white">
            <div class="p-8">
                ...
                <p class="text-center mb-2">Check out my current stacks, plus this animated icons!</p>
                <p class="text-center italic text-sm">PS: Keep in mind that these may have different proficiencies.</p>
            </div>
...
function Portofolio() {
    return (
        <body>
            ...
            <p class="text-center mb-8">See the projects that I've been working around.</p>
            <Portofolio_stacks />
        </body>
    )
}
